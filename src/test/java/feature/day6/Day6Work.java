...
public class Day6Work {
    ...
    public Object[][] provideTestData() {
        String excelFilePath = "dataBookDemo.xlsx";
    ...
    @Test(dataProvider = "demoData")
    public void testSubmitNull(Map<String, String> rowData) {
        driver.findElement(By.xpath("//button[@type='submit']")).click();
    ...
    public void testLastNameNull(Map<String, String> rowData) {
        ...
        WebElement errorMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[@id='InstructFirstName']")));
        String actualMessage = errorMessage.getText();
        Assert.assertEquals(actualMessage, "This field is required", "Error message does not match " +
                "expected.");
